...
//s 3 row= {<111111000000000000><000000110000000000><000000000000110000><110000000000000000><000000111111000000><000000000000000011><000011000000000000><000000000011000000><000000000000111111>}
//i 3 row= {<001100000000000000><000000001100000000><000000000000001100><001100000000000000><000000001100000000><000000000000001100><001100000000000000><000000001100000000><000000000000001100>}
//n 3 row= {<110000000001100000><000000110000001100><000000000000110011><110000000001100000><000000110000001100><000000000000110011><110000000001100000><000000110000001100><000000000000110011>}
//l 3 row= {<111111000000000000><000000110000000000><000000000000110000><110000000000000000><000000111111000000><000000000000000011><000011000000000000><000000000011000000><000000000000111111>}
//a 3 row= {<111111000000000000><000000110000000000><000000000000110000><110000000000000000><000000111111000000><000000000000000011><000011000000000000><000000000011000000><000000000000111111>}
//b 3 row= {<111111000000000000><000000110000000000><000000000000110000><110000000000000000><000000111111000000><000000000000000011><000011000000000000><000000000011000000><000000000000111111>}
...
#define NUMSLICES  10// number of "slices" = height //8 = max independent from serial buffer
...
int shotS[BOXNUM][NUMSLICES];
int shotI[BOXNUM][NUMSLICES];
int shotN[BOXNUM][NUMSLICES];
int shotL[BOXNUM][NUMSLICES];
int shotA[BOXNUM][NUMSLICES];
int shotB[BOXNUM][NUMSLICES];
...
/////
//int [][] SSSS =new int[][]{{1,0,0,0},{1,0,1,0},{0,0,1,0},{0,1,1,0}};
  ...
  while(Serial.available() > 0){
    ...
    if(Mstarted == true){
      ...
      if(aChar == 0x7D){
        ...
        //flag to processing to start transmission
        //        Serial.print("!");
        delay(1000);
        break;     
      }
